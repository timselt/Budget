              ...
              <td className="px-4 py-3">
                {editingUserId === user.id ? (
                  <select
                    ...
                    className="rounded-md border border-sl-outline-variant/15 bg-sl-surface-lowest px-2 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-accent"
                  >
                ...
                {editingUserId === user.id ? (
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="rounded-md border border-sl-outline-variant/15 px-3 py-1 text-xs font-medium text-text-muted transition-colors hover:bg-surface-alt"
                    >
                      Iptal
                    </button>
                  </div>
